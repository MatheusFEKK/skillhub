...
export const PostTemplate:React.FC<PostProps> = (props) => {
    return(
        <View style={[styles.alignItemsCenter, {backgroundColor:'#F4F7FD', width:350, height:487, borderRadius:15}]}>
            ...
            {props.UserImage == undefined ? (
                ...
                <View style={{position:'absolute',top:420,alignSelf:'flex-start', marginLeft:20, marginTop:15}}>
